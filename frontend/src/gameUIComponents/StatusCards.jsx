    ...
    <>
      ...
      <div className="card" style={{ flex: 1 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0, lineHeight: '1.8' }}>
          <li>🪵 Wood: <strong>{me.resources?.wood || 0}</strong></li>
          <li>🍖 Food: <strong>{me.resources?.food || 0}</strong></li>
          <li>⛏️ Iron: <strong>{me.resources?.iron || 0}</strong></li>
        </ul>
        <hr style={{ margin: '15px 0', borderTop: '1px solid #eee' }} />
        <h3>Health Status</h3>
        <p>State: <strong style={{ color: me.health === 'healthy' ? '#2e7d32' : '#c62828' }}>
      ...
      <div className="card" style={{ flex: 1 }}>
        ...
        {!me.developments || me.developments.length === 0 ? (
          <p style={{ color: '#888', fontStyle: 'italic' }}>No developments yet.</p>
        ) : (
