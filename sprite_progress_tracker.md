...
- The next remaining plan work is panel attention state and then responsive/accessibility/multiplayer acceptance. Authoritative timer transport remains blocked on unanswered question 17, and the human/agent `game_length` projection split should be audited before declaring the state-contract task complete.
